...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  attributes: {
    ...
    pageUrl: Attribute.UID<'api::service.service', 'service_name'> &
      Attribute.Required;
    category: Attribute.Relation<
      'api::service.service',
      'oneToOne',
    ...
    photo: Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Attribute.Required;
    service_heading_1: Attribute.String & Attribute.Required;
    service_description_1: Attribute.Text & Attribute.Required;
    documents_required: Attribute.Text & Attribute.Required;
